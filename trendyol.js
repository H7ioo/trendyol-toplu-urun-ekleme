...
var casesTypes = ["Arka Kapak", "Cüzdan Kılıf", "Çerçeve"];
// Garanti for The Phone Case
var guaranteesPeriod = [
    "1 Yıl",
    "2 Yıl",
    "3 Yıl",
    "4 Yıl",
...
function compile(_a) {
    var brand = _a.brand, caseBrand = _a.caseBrand, caseType = _a.caseType, colors = _a.colors, description = _a.description, globalPrice = _a.globalPrice, guaranteePeriod = _a.guaranteePeriod, mainModalCode = _a.mainModalCode, material = _a.material, phoneType = _a.phoneType, phonesList = _a.phonesList, price = _a.price, stock = _a.stock, title = _a.title, path = _a.path;
    var res = [];
    for (var i = 0; i < phonesList.length; i++) {
        ...
        for (var j = 0; j < colors.length; j++) {
            ...
            fields["Marka"] = brand !== null && brand !== void 0 ? brand : "";
